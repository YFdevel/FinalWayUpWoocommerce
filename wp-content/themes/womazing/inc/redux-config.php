...
require_once get_template_directory() . '/inc/redux-components/home/top-section-foto.php';
require_once get_template_directory() . '/inc/redux-components/home/top-section-gallery.php';
require_once get_template_directory() . '/inc/redux-components/home/new-collection.php';
require_once get_template_directory() . '/inc/redux-components/home/important.php';
require_once get_template_directory() . '/inc/redux-components/home/dream.php';
require_once get_template_directory() . '/inc/redux-components/home/dream-images.php';
...
Redux::set_section(
    ...
    array(
        ...
        'id'               => 'header',
        'desc'             => esc_html__( 'Редактирование шапки сайта', 'your-textdomain-here' ),
        'customizer_width' => '400px',
    )
);
require_once get_template_directory() . '/inc/redux-components/header-content.php';
...
Redux::set_section(
    ...
    array(
        ...
        'id'               => 'footer',
        'desc'             => esc_html__( 'Редактирование футера', 'your-textdomain-here' ),
        'customizer_width' => '400px',
    )
);
require_once get_template_directory() . '/inc/redux-components/footer-content.php';
...
require_once get_template_directory() . '/inc/redux-components/about-brand/about-brand.php';
...
Redux::set_section(
    ...
    array(
        ...
        'id'               => 'contact-page',
        'desc'             => esc_html__( 'Редактирование страницы Контакты', 'your-textdomain-here' ),
        'customizer_width' => '400px',
    )
);
require_once get_template_directory() . '/inc/redux-components/contacts/contact-page.php';
...
Redux::set_section(
    ...
    array(
        ...
        'id'               => 'modal-window',
        'desc'             => esc_html__( 'Редактирование модального окна', 'your-textdomain-here' ),
        'customizer_width' => '400px',
    )
);
