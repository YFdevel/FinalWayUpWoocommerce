                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="success-info-wrapper">
                            <img src="<?= $redux['success-image']['url'] ?>" alt="success" class="success-img">
                            <div class="success-info">
                                <h3 class="success-info__title"><?= $redux['success-subtitle'] ?></h3>
                                <p class="success-info__text"><?= $redux['success-text'] ?></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="success-btn-wrapper">
                            <a href="/final-wayup/"
                               class="success-btn btn btn-green"><?= $redux['success-btn-text'] ?></a>
                        </div>
                    </div>
                </div>
            </div>
